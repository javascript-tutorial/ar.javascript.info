...
في الجافا سكريبت فإن الدوال ليست بنية سحرية للغة ولكنها نوع خاص من القيم.
...
لاحظ أن آخر سطر لا يقوم بتنفيذ الدالة لعدم وجود قوسين بعد `sayHi`. هناك لغات برمجة حيث يمكنك استدعاء الدالة بمجرد ذكر اسمها ولكن الجافا سكريبت ليست منهم.

في الجافا سكريبت الدالة هي قيمة لذلك يمكننا معاملتها مثل أي قيمة والكود بالأعلى يعرض نص به الكود الخاص بها
...
كود مثل هذا يظهر في برامجنا بشكل طبيعي. إنه في روح الجافا سكريبت.
...
وفقًا لخوارزميات داخلية فعندما تقوم الجافا سكريبت بالتجهيز لتنفيذ البرنامج فهي تبحث عن Function Declarations العالمية وتقوم بإنشاء هذه الدوال كخطوة في مرحلة التهيئة initialization stage.
...
تعريف الدالة `sayHi` يتم عندما تقوم الجافا سكريبت بالتجهيز لتنفيذ البرنامج ويكون متاح في أي مكان.
