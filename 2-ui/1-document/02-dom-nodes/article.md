...
4. التعليقات comments -- في بعض الأحيان يُمكن وضع معلومات بها، لن يتم عرض المعلومات، ولكن يُمكن قرائتها من نموذج كائن المستند باستخدام الجافا سكريبت.
...
أثناء العمل مع نموذج كائن المستند، قد نرغب أيضا في تطبيق الجافا سكريبت عليه. مثل: إيجاد عقدة وتشغيل بعض التعليمات البرمجية لتعديلها، وذلك لرؤية النتيجة. إليك بعض النصائح للتنقل بين علامتي التبويب Elements و console.
...
وهذا بالطبع لأغراض التصحيح debugging. بدءا من الفصل التالي، سنقوم بالوصول إلى نموذج كائن المستند وتعديله باستخدام الجافا سكريبت.
